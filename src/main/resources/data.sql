...
INSERT INTO user (ID, LOGIN_ID, PASSWORD, NICKNAME, ACTIVATED, EMAIL, name, COLLEGE_CODE, DEPARTMENT, STUDENT_NUM, EMAIL_AUTHENTICATION, DELETED) VALUES (2, 'user1', '$2a$10$nicQMhS9JcPhrd3E/gc8gOHran0UsHvcIjfUUu9qGA.xD4rbaXbG2', 'user1', 1, '22222@naver.com', 'seilpark', '001', 'd001', 32210312, FALSE, FALSE);
