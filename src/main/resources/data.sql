...
INSERT INTO COLLEGE (COLLEGE_NAME) values ('빈값');
INSERT INTO COLLEGE (COLLEGE_NAME) values ('한국대학교');

--campus 생성
INSERT INTO CAMPUS (NAME, ADDRESS, COLLEGE_SEQ, COLLEGE_ID) values ('빈값', '빈값', -1, 1);
INSERT INTO CAMPUS (NAME, ADDRESS, COLLEGE_SEQ, COLLEGE_ID) values ('본교', '세종특별자치시 갈매로 408, 14동', 0, 2);
